...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.label_info_1 = customtkinter.CTkLabel(master=self.frame_info,
                                                   text="PY-Template: Lorem ipsum dolor sit,\n" +
        ...
        self.button_3.configure(state="disabled", text="Disabled PY-Template")
        self.combobox_1.set("PYTCombobox")
    ...
    def button_event(self):
        print(QueryBuilder().table('users').select('name').first())
