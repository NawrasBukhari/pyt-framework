from orm.schema.Blueprint import Blueprint
from orm.schema.Table import Table
from orm.schema.TableDiff import TableDiff
from orm.exceptions import ConnectionNotRegistered
...
class Schema:
    ...
    def create(self, table):
        ...
        Returns:
            orm.blueprint.Blueprint -- The Masonite ORM blueprint object.
        """
        self._table = table
