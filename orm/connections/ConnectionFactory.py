...
class ConnectionFactory:
    ...
    def register(cls, key, connection):
        ...
        Arguments:
            ...
            connection {orm.connections.BaseConnection} -- An instance of a BaseConnection class.
    ...
    def make(self, key):
        ...
        Returns:
            orm.connection.BaseConnection -- Returns an instance of a BaseConnection class.
        """
