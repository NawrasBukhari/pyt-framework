...
from orm.connections.ConnectionResolver import ConnectionResolver
...
class BaseConnection:
    ...
    def log(
        self, query, bindings, query_time=0, logger="orm.connections.queries"
    ):
        logger = logging.getLogger("orm.connection.queries")
