...
from orm.collection.Collection import Collection
from orm.expressions.expressions import (
    JoinClause,
    SubGroupExpression,
    SubSelectExpression,
    SelectExpression,
...
class QueryBuilder(ObservesEvents):
    ...
    def __init__(
        ...
        Arguments:
            grammar {orm.grammar.Grammar} -- A grammar class.

        Keyword Arguments:
            connection {orm.connection.Connection} -- A connection class (default: {None})
    ...
    def set_scope(self, name, callable):
        ...
        Arguments:
            cls {orm.Model} -- An ORM model class.
    ...
    def get_grammar(self):
        ...
        Returns:
            orm.grammar.Grammar -- An ORM grammar class.
        """
